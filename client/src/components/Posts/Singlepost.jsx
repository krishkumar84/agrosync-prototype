...
function Singlepost() {
  ...
  const handlePayment = async () => {
    ...
    const options = {
      key: "rzp_test_sDLUPk7PDByU6u", // Your Razorpay test key
      amount: data.price * 100, // Amount in paise (e.g., 1000 paise = ₹10)
      currency: "INR",
      name: "Crop Purchase",
      description: data.shortTitle,
    ...
    paymentObject.on("payment.failed", function (response) {
      alert(
        "Payment failed. Please try again. Error: " + response.error.description
      );
    });
              ...
              <div className="mt-12 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="info flex flex-col">
                    ...
                    <button className="bg-green-500  text-white rounded-sm mt-2 p-2 cursor-pointer">
                      Contact Me
                    </button>
                  </div>
                </div>
          ...
          <div className="flex-1 border-3 border-gray-400 p-5 flex flex-wrap flex-col gap-5 sm:sticky  top-[50px] max-h-content max-h-[500px] ">
            ...
            <div className="flex flex-col gap-3">
              {data.features.map((feature) => (
                <div
                  className="flex items-center gap-3 text-medium text-gray-600"
                  key={feature}
                >
            ...
            <button
              className="bg-green-600 p-3 text-white rounded-md border-none font-medium text-lg cursor-pointer"
